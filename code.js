...
function doGet(e) {
  // If a payload param is present, this is a data request from gasCall â€” handle it
  // NOTE: No script lock on GET â€” locks hang indefinitely on GET requests in GAS.
  ...
  // No payload â€” serve the HTML page
...
// â”€â”€ DATA ENGINE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
function markJobComplete(p) {
  ...
  // Trusting frontend value â€” same pattern as updateJobDetails.
  ...
  if (p.markPaid) {
    ...
    // Job was already fully paid; additional cost (e.g. tip) added at completion â€” record a payment for the delta
    appendRow(TABS.PAYMENTS, {
      Payment_ID:     uid('PAY'),
      Job_ID:         p.jobId,
      Client_ID:      existingJob.Client_ID,
...
// FIX: was missing â€” called by markInvoicePaid
